...
FIELDS = {
    ...
    'capability': ('#a78bfa', 246, 0.80, 'Inputs. The ground leans indigo, for compute and silicon.'),
    'alignment':  ('#4fc3a1', 197, 0.80, 'Safety. A colder, greener blue.'),
    'adoption':   ('#e891a8', 258, 0.72, 'People. The warmest ground here, a blue-violet.'),
    ...
    'news':       ('#f0996b', 231, 0.88, 'The wire. A plain blue, a little off the base.'),
...
with io.open(path, 'w', encoding='utf-8') as f:
    ...
    f.write('\n\n   GENERATED by scratchpad/gen_fields.py. Do not hand-edit.\n')
